const users = [{ "index": 0, "isActive": true, "balance": "$2,226.60", "name": "Eugenia Sawyer", "gender": "female", "phone": "+1 (840) 583-3207", "address": "949 John Street, Rose, Puerto Rico, 1857" },
...
const phones = 'Phone numbers of users with a balance of more than $2,000 :  ' + tel;
const sumAllBalance = '\nThe sum of all user balances is equal : $' + sumBalance.toFixed(2);


alert(phones + sumAllBalance);
